...
class DashboardTermController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/term')->with('success', 'Berhasil di tambahkan!');
    }
    ...
    public function update(Request $request, Term $term)
    {
        ...
        return redirect('/term')->with('success', 'Berhasil di ubah!');
    }
    ...
    public function destroy(Term $term)
    {
        ...
        return redirect('/term')->with('success', 'Berhasil di hapus!');
    }
}

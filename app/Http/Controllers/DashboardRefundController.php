...
class DashboardRefundController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/refund')->with('success', 'Berhasil di tambahkan!');
    }
    ...
    public function update(Request $request, Refund $refund)
    {
        ...
        return redirect('/refund')->with('success', 'Berhasil di ubah!');
    }
    ...
    public function destroy(Refund $refund)
    {
        ...
        return redirect('/refund')->with('success', 'Berhasil di hapus!');
    }
}

...
<div class="hero vh-100 d-flex align-items-center">
    <div class="container">
        ...
        <div class="col-lg-7 mx-auto text-center">
          <h1 class="display-4 text-white">Selamat datang di Kamar</h1>
          <p class="text-white">Kamar.co.id</p>
...
<div class="container pb-5">
    ...
    <section id="about">
        ...
        <div class="row">
          <div class="col-lg-6 ">
            @foreach ($data as $about)
            <p class="about pt-3 text-dark" >{!! $about->body !!}</p>
            ...
            {{-- App Kamar merupakan sebuah platform dekstop yang menyediakan beberapa fitur. 
              ...
              <div class="pt-5 text-center">
                <a href="/contactus">
                  <button class="contactus shadow">Hubungi Kami</button>
                </a>
              </div>
          </div>
